...
export default function Emergency() {
  ...
  const typeColors = {
    ...
    crisis: 'bg-orange-100 text-orange-800 border-orange-200',
    campus: 'bg-blue-100 text-blue-800 border-blue-200',
    support: 'bg-emerald-100 text-emerald-800 border-emerald-200',
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 pt-20 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-slate-800">Emergency Support</h1>
          </div>
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          ...
                          {contact.available24h && (
                            <div className="flex items-center space-x-1 text-xs font-medium opacity-75">
                              <Clock size={12} />
                              <span>24/7</span>
                            </div>
                          )}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <motion.button
                            ...
                            className="flex items-center space-x-2 px-4 py-2 bg-white/50 rounded-lg hover:bg-white/75 transition-colors"
                          >
                            <Phone size={16} />
                            <span>Call</span>
                          </motion.button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {copingStrategies.map((strategy, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-xl shadow-sm border border-slate-200 p-6"
                >
                  <h4 className="text-lg font-semibold text-slate-800 mb-2">{strategy.title}</h4>
